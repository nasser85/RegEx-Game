module.exports = function (highestScore, $state, $timeout, $log, $scope, questions, user, ValidateAnswerFactory, QuestionFactory, GeneratedQuestion, UserFactory, ScoreFactory) {
